"""Legacy façade around the new service layer.

The real business logic now lives in ``services.organizations``.
These thin wrappers keep backward compatibility if something
imports ``methods.*`` directly.
"""
